...
@app.route('/')
def index():
    return render_template('C:/Users/MAGENDRAN/Desktop/template/index.html',user=user)
@app.route('/sign_to_speech')
def sign_to_speech():
    return render_template(r'C:/Users/MAGENDRAN/Desktop/template/sign_to_speech.html')
@app.route('/speech_to_sign')
def speech_to_sign():
    return render_template('C:/Users/MAGENDRAN/Desktop/speech_to_sign.html')
